...
class FingerprintView {
    ...
    init() {
        ...
        // 4. Radius of the graph
        // We calculate the maximum possible radius to fit on our virtual canvas.
       this.radius = Math.min(this.width, this.height) / 1.3;
        ...
        this.svg = container.append('svg')
            ...
            .attr('preserveAspectRatio', 'xMidYMid meet') // Keep proportion
